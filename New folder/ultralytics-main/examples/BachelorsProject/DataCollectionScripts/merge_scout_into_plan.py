...
def main() -> int:
    ...
    scout_plan_path = _resolve_project_path(args.scout_plan)
    existing_plan_path = _resolve_project_path(args.existing_plan)
    output_plan_path = _resolve_project_path(args.output_plan)
