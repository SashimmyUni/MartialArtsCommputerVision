...
ref_dir = PROJECT_ROOT / "reference_poses"
...
print(f"  [OK]   With >=4 samples: {len(good_ready)}")
print(f"  [LOW]  With 1-3 samples: {len(low_ready)}")
print(f"  [NONE] With 0 samples: {len(missing_ready)}")
