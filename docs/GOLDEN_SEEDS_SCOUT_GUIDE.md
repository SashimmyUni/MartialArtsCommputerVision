...
```powershell
python scripts/scout_youtube_by_golden_seeds.py --api-key YOUR_API_KEY --technique jab
```
...
python scripts/scout_youtube_by_golden_seeds.py
```

### Option 2: Command Line

```powershell
python scripts/scout_youtube_by_golden_seeds.py --api-key "YOUR_API_KEY_HERE"
```
