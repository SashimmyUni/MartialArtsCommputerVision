...
```powershell
python scripts/scout_youtube_by_golden_seeds.py --api-key KEY --technique jab
python scripts/scout_youtube_by_golden_seeds.py --api-key KEY --technique roundhouse_kick
python scripts/scout_youtube_by_golden_seeds.py --api-key KEY  # All techniques
```
...
Next steps:
  ...
  3. Run: python scripts/run_reference_collection_batch.py
```

### 3. Merge Results

```powershell
python scripts/merge_scout_into_plan.py `
...
```powershell
python scripts/scout_youtube_by_golden_seeds.py --api-key KEY --min-view-count 500
```

Increase pages per query:
```powershell
python scripts/scout_youtube_by_golden_seeds.py --api-key KEY --max-pages-per-query 5
```
...
```powershell
python scripts/scout_youtube_by_golden_seeds.py --api-key KEY --min-view-count 5000
```

Decrease duration range:
```powershell
python scripts/scout_youtube_by_golden_seeds.py --api-key KEY `
...
3. Try scouting one technique: `python scripts/scout_youtube_by_golden_seeds.py --api-key KEY --technique jab --dry-run`
